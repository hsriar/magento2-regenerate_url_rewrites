 ...
 *
 * @package HsRiar_RegenerateUrlRewrites
 * @author Hs Riar <hsriar.work@gmail.com>
 * @copyright 2020 HsRiar
 * @license OSL-3.0, AFL-3.0
 */

namespace HsRiar\RegenerateUrlRewrites\Console\Command;
...
abstract class RegenerateUrlRewritesAbstract extends Command
{
    ...
    protected function _showSupportMe()
    {
        ...
        $this->_output->writeln('https://www.hsriar.com/');
        $this->_output->writeln('----------------------------------------------------');
        $this->_output->writeln('');
    }
    ...
    protected function _runClearCache()
    {
        if ($this->_commandOptions['runCacheClean'] || $this->_commandOptions['runCacheFlush']) {
            ...
            $this->_output->writeln('If you are getting some issue please contact me using email : hsriar.work@gmail.com');
        }
    }
